                        ...
                        <div className="space-y-3">
                            {FINISHED_GOODS.map((product) => {
                                ...
                                return (
                                    <div
                                        key={product.value}
                                        className={`p-3 border rounded-lg flex items-center justify-between ${completed ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'
                                            }`}
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                {!product.required && product.value === LabTestCategory.POPSICLES && (
